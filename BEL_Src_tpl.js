var app = (function () {
            ...
            function updateTransformations(model) {
                ...
                if (animate) {
                    let oldIllumination_0 = illumination.light[0];
                    let oldIllumination_1 = illumination.light[1];

                    currentOrbitDegree_0 += orbitDegree_0;
                    currentOrbitDegree_1 -= orbitDegree_1;

                    let x_0 = orbitRadius_0[0] * Math.cos(currentOrbitDegree_0) - orbitCenter_0[0];
                    let y_0 = orbitRadius_0[1] * Math.sin(currentOrbitDegree_0) - orbitCenter_0[1];

                    let x_1 = orbitRadius_1[0] * Math.cos(currentOrbitDegree_1) - orbitCenter_1[0];
                    let y_1 = orbitRadius_1[1] * Math.sin(currentOrbitDegree_1) - orbitCenter_1[1];

                    illumination.light[0].position = [x_0, oldIllumination_0.position[1], y_0];
                    illumination.light[1].position = [x_1, y_1, oldIllumination_1.position[1] + 4];
                }
            }
            ...
            let orbitDegree_1 = Math.PI / 300;
            let orbitRadius_0 = [5., 5.];
            let orbitRadius_1 = [5., 5.];
